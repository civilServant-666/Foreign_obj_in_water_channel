...
dtclassifier = DecisionTreeClassifier(criterion="entropy", splitter="best", max_depth=8)
scoring = ['accuracy', 'f1_weighted', 'f1_macro', 'f1']
k_val = 5
scores = cross_validate(dtclassifier,X_train,y_train,cv=k_val,scoring=scoring)
sorted(scores.keys())
